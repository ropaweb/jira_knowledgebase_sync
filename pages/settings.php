...
$field->setLabel(rex_i18n::msg('jira_knowledgebase_sync_config_mytextfield_label'));
$field->setNotice(rex_i18n::msg('jira_knowledgebase_sync_config_mytextfield_notice'));
